...
- Gateway client for chat completions, responses, models, embeddings, Anthropic-compatible messages, and SSE streaming on `https://api.owlvigil.com`.
- Management client for workspaces, Gateway keys, usage, quota, balance, invoices, logs, traces, webhook endpoints, and webhook events on `https://open.owlvigil.com/open/v1`.
